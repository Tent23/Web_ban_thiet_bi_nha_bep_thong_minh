    ...
    <nav class="header__nav">
        <div class="container">
            <ul>
                ...
                </li>                <li class="nav-item"><a href="#">Giải pháp & Combo</a></li>
            ...
            <div class="shop-layout">
                ...
                <aside class="shop-sidebar">
                    <div class="filter-group">
                        <h3>Danh mục</h3>
                        <ul>
                            <li><label><input type="checkbox"> Bếp từ thông minh</label></li>
                            <li><label><input type="checkbox"> Robot hút bụi</label></li>
                            <li><label><input type="checkbox"> Máy rửa bát</label></li>
                            <li><label><input type="checkbox"> Tủ lạnh</label></li>
                            <li><label><input type="checkbox"> Lò nướng / Vi sóng</label></li>
                        </ul>
                    </div>
                    <div class="filter-group">
                        <h3>Thương hiệu</h3>
                        <ul>
                            ...
                            <li><label><input type="checkbox"> Hafele</label></li>
                            <li><label><input type="checkbox"> Ecovacs</label></li>
                        </ul>
                    </div>
                    <div class="filter-group">
                        <h3>Khoảng giá</h3>
                        <ul>
                            <li><label><input type="radio" name="price"> Dưới 5 triệu</label></li>
                            <li><label><input type="radio" name="price"> 5 - 10 triệu</label></li>
                            <li><label><input type="radio" name="price"> 10 - 20 triệu</label></li>
                            <li><label><input type="radio" name="price"> Trên 20 triệu</label></li>
                        </ul>
                    </div>
                </aside>
