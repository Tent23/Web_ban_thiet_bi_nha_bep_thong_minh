        ...
        <div class="header__main">
            <div class="container">
                ...
                <div class="header__actions">
                    <a href="Account.html"><i class="fa fa-user"></i> Tài khoản</a>
                    <a href="../ThanhTruong/giohang.html"><i class="fa fa-heart"></i> Yêu thích</a>
            ...
            <div class="container">
                <ul>
                    <li class="nav-item has-megamenu">
                        ...
                        <div class="mega-menu">
                            <a href="Beptu.html">Bếp từ</a>
                            <a href="Tulanh.html">Tủ lạnh</a>
                            <a href="Robot.html">Robot Hút bụi</a>
                            <a href="Mayruabat.html">Máy rửa bát</a>
                            <a href="Cambien.html">Cảm biến & An ninh</a>
                            <a href="Phache.html">Pha chế</a>
                        </div>
                    </li>
        ...
        <div class="profile-wrapper">
            ...
            <div class="profile-sidebar">
                <div class="sidebar-user">
                    ...
                    <div class="username">toantuim</div>
                </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="#" class="submenu-item active">Hồ Sơ</a></li>
                    <li><a href="#" class="submenu-item">Ngân Hàng</a></li>
                    <li><a href="#" class="submenu-item">Địa Chỉ</a></li>
                    <li><a href="#" class="submenu-item">Đổi Mật Khẩu</a>
                    </li>
                    <li>
                        <a href="Donhang.html" class="menu-item">
            ...
            <section class="profile-content">
                <h2>Hồ Sơ Của Tôi</h2>
                <p class="sub">Quản lý thông tin hồ sơ để bảo mật tài khoản</p>

                <form class="profile-form">
                    <div class="form-group">
                        <label>Tên đăng nhập</label>
                        <input type="text" value="toantuim" readonly>
                    </div>

                    <div class="form-group">
                        <label>Tên</label>
                        <input type="text" value="Toàn">
                    </div>

                    <div class="form-group">
                        <label>Email</label>
                        <span>qt*******@gmail.com</span>
            ...
            <div class="avatar-section">
                <div class="avatar-big">To</div>
                <button class="upload-btn">Chọn ảnh</button>
                <p class="note">Dung lượng file tối đa 1MB<br>Định dạng: JPEG, PNG</p>
            </div>
