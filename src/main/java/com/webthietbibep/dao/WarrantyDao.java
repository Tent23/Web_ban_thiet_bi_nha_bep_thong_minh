    ...
    public List<Warranty> getSearchListWarranty(String type , String pra) {
        return get().withHandle(h ->{
            if(type == null){
                ...
                return h.createQuery("select w.series , p.name as productName,w.product_id as productId,CONCAT(u.last_name , ' ' , u.first_name) as customerName, w.customer_id as customerId,w.order_id as orderId , u.phone as phoneNumber , w.purchase_date as purchaseDate, w.warranty_time  \n" +
