...
public class OrdersDAO extends BaseDao {
    public int insert(Order o) {
        String sql = """
        INSERT INTO orders
        (user_id, address_id, total_amount, status, payment_method, note,signature, key_id, signed_data)
        VALUES (:uid, :aid, :total, :status, :pm, :note,:sig, :kid, :sdata)
    """;
